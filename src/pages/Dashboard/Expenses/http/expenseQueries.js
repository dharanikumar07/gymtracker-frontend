...
import { 
    ...
    updateBudgetPlanApi,
    deleteBudgetPlanApi,
    activateBudgetPlanApi,
    getBudgetPlanStatusApi
} from './expenseApi';
...
export const useLogExpenseMutation = () => {
    ...
    return useMutation({
        ...
        onError: (error) => {
            toast.error(error.response?.data?.errors || "Failed to commit expense");
        }
    });
};
...
export const useDeleteExpenseMutation = () => {
    ...
    return useMutation({
        ...
        onError: (error) => {
            toast.error(error.response?.data?.errors || "Failed to delete expense");
        }
    });
};
...
export const useCreateBudgetPlanMutation = () => {
    ...
    return useMutation({
        ...
        onError: (error) => {
            toast.error(error.response?.data?.errors || "Failed to create budget plan");
        }
    });
};
...
export const useUpdateBudgetPlanMutation = () => {
    ...
    return useMutation({
        ...
        onError: (error) => {
            toast.error(error.response?.data?.errors || "Failed to update budget plan");
        }
    });
};
...
export const useDeleteBudgetPlanMutation = () => {
    ...
    return useMutation({
        ...
        onError: (error) => {
            toast.error(error.response?.data?.errors || "Failed to delete budget plan");
        }
    });
};
...
export const useActivateBudgetPlanMutation = () => {
    ...
    return useMutation({
        ...
        onError: (error) => {
            toast.error(error.response?.data?.errors || "Failed to activate budget plan");
        }
    });
};
